...
fn smoke() {
    ...
    assert_eq!(
        project.main,
        (
            "amr_simple.tree".to_string(),
            "place_ball_to_target".to_string()
        )
    );
    ...
    assert_eq!(
        ...
        HashMap::from_iter(vec![(
            "nested/impls.tree".to_string(),
            HashSet::from_iter(vec![
                ImportName::Alias("grasp".to_string(), "grasp_ball".to_string()),
    ...
    assert_eq!(
        file.definitions.get("place_ball_to_target"),
        Some(&Tree::root(
                ...
                Calls::new(vec![
                    Call::invocation(
                        ...
                        Arguments::new(vec![
                            Argument::id_mes(
                                "obj",
                                Message::object(vec![("x".to_string(), Message::int(1)),])
                            ),
                            Argument::id_call(
                                "operation",
                                Call::invocation(
                                    "place",
                                    Arguments::new(vec![Argument::mes(Message::array(vec![
                                        Message::int(10)
                                    ]))])
                                )
                            )
            ...
            Calls::new(vec![
                Call::lambda(
                    ...
                    Calls::new(vec![
                        Call::invocation(
                            "is_approachable",
                            Arguments::new(vec![Argument::id("what")])
                        ),
                        Call::invocation(
                            "do_job",
                            Arguments::new(vec![Argument::call(Call::invocation(
                                "approach",
                                Arguments::new(vec![Argument::id("what")])
                            ))])
                        ),
    ...
    assert_eq!(
        ...
        Some(&Tree::new(
            ...
            Calls::new(vec![
                Call::invocation(
                    "is_valid_place",
                    Arguments::new(vec![Argument::id("where")])
                ),
                Call::invocation(
                    "do_job",
                    Arguments::new(vec![Argument::call(Call::invocation(
                        "slowly_drop",
                        Arguments::new(vec![Argument::mes(Message::object(vec![(
                            "cord".to_string(),
                            Message::int(1)
                        )]))])
                    ))])
    ...
    assert_eq!(
        file.definitions.get("do_job"),
        Some(&Tree::new(
            TreeType::Sequence,
            "do_job".to_string(),
            Params::new(vec![Param::new("action", MesType::Tree),]),
            Calls::new(vec![
                Call::invocation("savepoint", Arguments::default()),
                Call::ho_invocation("action"),
                Call::invocation("savepoint", Arguments::default()),
            ]),
        ))
    );
