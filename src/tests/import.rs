    ...
    assert_eq!(
        ...
        HashMap::from_iter(vec![
            ...
            (
                ...
                Flow(
                    Root,
                    Name("main".to_string(), "main.tree".to_string()),
                    RtArgs(vec![]),
                    vec![2]
                )
            ),
            (
                3,
                Leaf(
                    Name("action".to_string(), "nested/nested2.tree".to_string()),
                    RtArgs(vec![])
                )
            ),
            (
                5,
                Leaf(
                    Name("h".to_string(), "../util.tree".to_string()),
                    RtArgs(vec![])
                )
            ),
        ])
